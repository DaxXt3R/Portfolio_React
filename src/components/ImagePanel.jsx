  ...
  return (
    ...
    >
      <img
        src={src}
        alt=""
        className="grayscale hover:grayscale-0 duration-500 object-cover size-full"
      />
      <div
        id="label"
        className={
          "w-full bg-[rgba(0,0,0,50%)] text-white font-medium absolute bottom-0 line-clamp-2 duration-200 text-center " +
