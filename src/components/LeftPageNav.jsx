  ...
  return (
    <aside className="flex-col h-[60vh] absolute left-10 top-[20vh] hidden lg:flex">
      ...
      <div className="z-10 flex flex-col justify-around flex-1">
        <LeftPageNavButton num="01" active={activePage===1} onClick={()=>{toggleButton(1)}} href="/">
          Здравей
        </LeftPageNavButton>
        
				<LeftPageNavButton num="02" active={activePage===2} onClick={()=>{toggleButton(2)}} href="/skills">
					Умения
				</LeftPageNavButton>
